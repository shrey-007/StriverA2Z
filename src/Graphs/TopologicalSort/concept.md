1. it only exists for DAG(directed acyclic graph). Obviously it is common sense ki undirected graph and cyclic graph mai esi ordering banegi hi nhi kabhi.
